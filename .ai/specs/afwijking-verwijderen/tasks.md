...
- [ ] 1. Schrijf `handleDeleteException(body)` in `src/bezorgservice.js` — valideer
...
- [ ] 3. Voeg `AfwijkingVerwijderen`-schema toe aan `docs/openapi.yaml`
- [ ] 4. Voeg subsectie toe aan `docs/chatgpt-prompt.md` met bevestigingsstap
