...
- De GPT vraagt altijd bevestiging vóór het inactiveren ("Weet je zeker...?")
- Na inactiveren is de medewerker nog zichtbaar via `GET action=medewerkers`
