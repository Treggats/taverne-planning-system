...
- [x] 1. Voeg `EXPORT_TEMPLATE_ID` en `WEEKPLANNINGEN_FOLDER_ID` toe aan `src/config.js`
- [x] 2. Maak `src/export.js` aan met:
...
- [x] 3. Voeg routing toe in `src/main.js`: `POST action=week_export`
- [x] 4. Voeg `week_export` toe aan `docs/openapi.yaml`
- [x] 5. Vervang `## Weekexport` in `docs/chatgpt-prompt.md` door één-commando beschrijving
