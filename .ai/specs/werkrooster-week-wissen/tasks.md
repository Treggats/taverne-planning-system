...
- [x] 1. Schrijf `handleWeekClear(body)` in `src/werkrooster.js`:
         valideer week/datum, verzamel rijnummers (van onderaf), verwijder ze
- [x] 2. Voeg routing toe in `src/main.js`
- [x] 3. Voeg `WeekWissen`-schema toe aan `docs/openapi.yaml`
- [x] 4. Voeg subsectie toe aan `docs/chatgpt-prompt.md` inclusief bevestigingsstap
